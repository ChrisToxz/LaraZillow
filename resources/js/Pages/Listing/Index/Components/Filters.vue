...
<template>
  <form>
    <div class="mb-8 mt-4 flex flex-wrap gap-2 dark:text-gray-600">
      ...
      <div class="flex flex-nowrap items-center">
        <select id="" name="" class="input-filter-l w-28">
          <option :value="null">Beds</option>
          <option v-for="n in 5" :key="n" :value="n">{{ n }}</option>
          <option>6+</option>
        </select>
        <select id="" name="" class="input-filter-r w-28">
      ...
      <button type="submit" class="btn-gray">Filter</button>
